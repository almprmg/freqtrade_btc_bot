"""Compare Rotation V1 / V2 / V3 vs Pure Shield, year-by-year."""
...
COMBOS = [
    ("Rotation_V1", "BtcRotationStrategy",    None, None,        "config.rotation.json"),
    ("Rotation_V2", "BtcRotationV2Strategy",  None, None,        "config.rotation_v2.json"),
    ("Rotation_V3", "BtcRotationV3Strategy",  None, None,        "config.rotation_v3.json"),
...
def main():
    ...
    df.to_csv(REPO / "research" / "rotation_versions_results.csv", index=False)
    return 0
