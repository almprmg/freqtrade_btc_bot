...
<li><b>vol-targeting</b> (use EWMA, not rolling-std) is a genuine, model-free improvement: ~halved drawdown. Tighter vol-target (0.02, cap 0.6) cuts portfolio maxDD to −19% with NO Sharpe loss; a drawdown circuit-breaker pushes DD to −14% but destroys return (whipsaw) — ~−19% is the practical floor.</li>
<li><b>Bigger models don't help:</b> 4-layer transformer (BTC +0.34) ≤ 2-layer (+0.42); hidden=128 ≤ 64. More capacity overfits the small daily dataset.</li>
